...
const endpoints = [new CoursesEndpoint_1.default(), new authEndpoint_1.default(), new QuestionsEndpoint_1.default(), new AchievementsEndpoint_1.default(), new ActivityEndpoint_1.default(), new UserEndpoint_1.default()];
let app = express();
